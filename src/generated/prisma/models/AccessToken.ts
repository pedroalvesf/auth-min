...
export type AccessTokenWhereInput = {
  ...
  revoked?: Prisma.BoolFilter<"AccessToken"> | boolean
...
export type AccessTokenScalarWhereWithAggregatesInput = {
  ...
  revoked?: Prisma.BoolWithAggregatesFilter<"AccessToken"> | boolean
}
...
export type AccessTokenOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "token" | "expiresAt" | "createdAt" | "revoked", ExtArgs["result"]["accessToken"]>
...
export interface AccessTokenFieldRefs {
  ...
  readonly revoked: Prisma.FieldRef<"AccessToken", 'Boolean'>
}
