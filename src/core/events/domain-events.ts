...
export class DomainEvents {
  ...
  private removeAggregateFromMarkedDispatchList(aggregate: AggregateRoot<unknown>) {
    const index = this.markedAggregates.findIndex(a => a.equals(aggregate))
    this.markedAggregates.splice(index, 1)
  }

  private findMarkedAggregateByID(id: UniqueEntityID): AggregateRoot<unknown> | undefined {
