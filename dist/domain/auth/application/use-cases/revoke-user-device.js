...
let RevokeUserDeviceUseCase = class RevokeUserDeviceUseCase {
    constructor(devicesRepository, refreshTokenRepository, accessTokenRepository) {
        this.devicesRepository = devicesRepository;
        this.refreshTokenRepository = refreshTokenRepository;
        this.accessTokenRepository = accessTokenRepository;
    }
    async execute({ userId, deviceId, }) {
        const device = await this.devicesRepository.findById(new unique_entity_id_1.UniqueEntityID(deviceId));
        if (!device) {
            return (0, either_1.left)(new device_not_found_error_1.DeviceNotFoundError());
        }
        ...
        await this.accessTokenRepository.revokeByUserId(new unique_entity_id_1.UniqueEntityID(userId));
...
exports.RevokeUserDeviceUseCase = RevokeUserDeviceUseCase = __decorate([
    ...
    __metadata("design:paramtypes", [devices_repository_1.DevicesRepository,
        refresh_token_repository_1.RefreshTokenRepository, Object])
